...
### Virtual University Concierge *(AI-Powered Assistant)*
...
- Answers questions such as: *"Where is my class?"* or *"What should I do first today?"*
...
| Screen | Description |
|--------|-------------|
| **Home Screen** | *"Hi Laura, where do you need to go today?"* |
...
| **Daily Agenda** | Classes of the day · *"Take me there"* button that opens navigation |

> 📎 *Insert wireframes, storyboards, or sketches here.*  
> *Show chatbot interface, agenda integration, and map navigation.*
...
> 📎 *Show "before and after" of the prototype after feedback.*
